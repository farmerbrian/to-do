...
// Module
___CSS_LOADER_EXPORT___.push([module.id, "body {\n  background-color: rgb(17, 16, 25);\n  /* box backgrounds will be #181C32 */\n  color: rgb(255, 255, 255);\n  font-family: sans-serif;\n  height: 100vh;\n  margin: 0;\n  padding: 0;\n}\n\n#page-container {\n  display: grid;\n  grid-template-columns: 250px auto;\n  grid-template-rows: 1fr;\n}\n\n#sidebar-container {\n  grid-column: 1 / 2;\n  background-color: #181c32;\n  height: 100vh;\n  padding: 20px;\n\n}\n\n#main-container {\n  grid-column: 2 / 3;\n  display: grid;\n  grid-template-rows: 50px auto;\n  padding: 25px;\n}\n\n#header-container {\n  grid-row: 1 / 2;\n  text-align: right;\n  background-color: #181c32;\n  border-radius: 10px;\n}\n\n#content-container {\n  grid-row: 2 /3;\n  text-align: center;\n  margin-top: 25px;\n  background-color: #181c32;\n  border-radius: 10px;\n}\n\n.task {\n  display: flex;\n  flex-direction: row;\n  padding-left: 15px;\n  padding-right: 15px;\n  margin: 10px;\n  border: 2px solid white ;\n  border-radius: 10px;\n  gap: 10px;\n}\n\n.task-name {\n  flex: 1 1 auto;\n  text-align: right;\n}", ""]);
// Exports
...
/* harmony import */ var _maketask_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(11);
...
// let tasks = [];
const taskA = (0,_maketask_js__WEBPACK_IMPORTED_MODULE_1__.makeTask)('Task A');
taskA.add();

const taskB = (0,_maketask_js__WEBPACK_IMPORTED_MODULE_1__.makeTask)('Task B');
taskB.add();

taskA.description = 'This is a task I need to do.';

(0,_maketask_js__WEBPACK_IMPORTED_MODULE_1__.updateTasks)(_maketask_js__WEBPACK_IMPORTED_MODULE_1__.tasks);
